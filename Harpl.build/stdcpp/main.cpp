...
int bb_lexer_Lexer::m_Tokenize(String t_txtStream,bb_compiler_Compiler* t_compiler,String t_sourceFile){
	...
	while(t_i<t_txtStream.Length()){
		...
		if(t_char>=97 && t_char<=122 || t_char>=65 && t_char<=90){
			...
			if(t_char>=48 && t_char<=57){
				...
				bb_token_Token* t_token2=(new bb_token_Token)->g_new(t_sourceFile,t_tokenInit2-t_lastOffset,t_lineNum,t_txtStream.Slice(t_tokenInit2,t_i),1);
				...
				if(t_char==34){
					...
					if(t_done3==false){
						errInfo="C:/Monkey Compiler/Harpl/compiler/lexer.monkey<65>";
						t_compiler->m_AddError(String(L"Expecting \""),t_sourceFile,t_tokenInit3-t_lastOffset-1,t_lineNum);
					}
					errInfo="C:/Monkey Compiler/Harpl/compiler/lexer.monkey<67>";
					bb_token_Token* t_token3=(new bb_token_Token)->g_new(t_sourceFile,t_tokenInit3-t_lastOffset-1,t_lineNum,t_txtStream.Slice(t_tokenInit3,t_i),2);
					errInfo="C:/Monkey Compiler/Harpl/compiler/lexer.monkey<68>";
					t_token3->f_text=bb_lexer_ScapeChars(t_token3->f_text);
					...
					if(t_char==39){
						...
						errInfo="C:/Monkey Compiler/Harpl/compiler/lexer.monkey<84>";
						...
						if(t_char==10 || t_char==59 || t_char==13){
							errInfo="C:/Monkey Compiler/Harpl/compiler/lexer.monkey<90>";
							bb_token_Token* t_token5=(new bb_token_Token)->g_new(t_sourceFile,t_i-t_lastOffset,t_lineNum,t_txtStream.Slice(t_i,t_i+1),16);
							errInfo="C:/Monkey Compiler/Harpl/compiler/lexer.monkey<91>";
							...
							if(t_char==43 || t_char==45 || t_char==42 || t_char==47 || t_char==37 || t_char==94 || t_char==38 || t_char==124 || t_char==62 || t_char==60 || t_char==61 || t_char==40 || t_char==41 || t_char==91 || t_char==93 || t_char==46){
								...
								bb_token_Token* t_token6=(new bb_token_Token)->g_new(t_sourceFile,t_i-t_lastOffset,t_lineNum,t_txtStream.Slice(t_i,t_i+1),8);
								...
								if(t_char==32 || t_char==9){
									...
									errInfo="C:/Monkey Compiler/Harpl/compiler/lexer.monkey<107>";
									if(t_char==33){
	...
	errInfo="C:/Monkey Compiler/Harpl/compiler/lexer.monkey<123>";
	errInfo="C:/Monkey Compiler/Harpl/compiler/lexer.monkey<123>";
...
bool bb_lexer_IsAValidIdentifierChar(int t_char){
	pushErr();
	errInfo="C:/Monkey Compiler/Harpl/compiler/lexer.monkey<131>";
