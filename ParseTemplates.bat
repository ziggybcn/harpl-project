@.\MonkeyTemplateParser\template_parser.build\stdcpp\main_winnt .\harplvm\runtime\binaryops.monkey
@.\MonkeyTemplateParser\template_parser.build\stdcpp\main_winnt .\harplvm\runtime\stringops.monkey
