...
bb_template_parser_Replacer* bb_template_parser_Replacer::g_new(){
	pushErr();
	errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<120>";
	popErr();
	return this;
}
...
String bb_template_parser_ParseDoc(String t_text,String t_fileLocation){
	pushErr();
	errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<126>";
...
String bb_template_parser_ParseDoc2(String t_text,Array<bb_template_parser_Replacer* > t_replaces,String t_fileLocation,String t_prefix,int t_level){
	...
	for(int t_i=0;t_i<t_lines.Length();t_i=t_i+1){
		...
		if(t_teststring.ToLower().StartsWith(String(L"'loadtemplate "))){
			...
			if(t_ignore==0){
				...
				errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<82>";
				Array<bb_template_parser_Replacer* > t_repArray=t_repList->m_ToArray();
				errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<83>";
				...
				errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<86>";
			...
			if(t_lines.At(t_i).Trim().ToLower()==String(L"'endtemplate")){
				errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<97>";
				t_ignore-=1;
			}
		}
		errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<99>";
		if(t_ignore==0){
			errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<100>";
	...
	errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<107>";
	String t_result=String();
	errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<107>";
	bool t_first=true;
	errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<108>";
	errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<108>";
	...
	errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<116>";
	if(t_ignore!=0){
		errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<116>";
		bb_template_parser_Error=true;
	}
	errInfo="C:/bmx2dev/harpl-project/MonkeyTemplateParser/template_parser.monkey<117>";
	popErr();
	return t_result;
}
int bbMain(){
