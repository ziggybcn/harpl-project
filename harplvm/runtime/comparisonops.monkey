...
Class MAJOR_EQUAL extends HarplFunction
	...
	if opKind1 = opKind2 Then
		...
		Select opKind1
			...
			Case expKinds.BC_BOOLVAR 
				'loadtemplate ./booleanperformoperation.Monkey, operation=>=, operator1=Bool1, operator2=Bool2, bytecodeobj=bco, virtualmachine=vm
				local result:Bool = Bool1 >= Bool2
			...
			Case expKinds.BC_INTVAR 
				'loadtemplate ./booleanperformoperation.Monkey, operation=>=, operator1=Int1, operator2=Int2, bytecodeobj=bco, virtualmachine=vm
				local result:Bool = Int1 >= Int2
				bco.pos+=1; Local varKind:Int = bco.code[bco.pos]
				Select varKind
					Case expKinds.BC_ARRAYVAR 
						Error("Can't convert from Boolean to array")
				...
				'endtemplate		
			Case expKinds.BC_FLOATVAR 
				'loadtemplate ./booleanperformoperation.Monkey, operation=>=, operator1=Float1, operator2=Float2, bytecodeobj=bco, virtualmachine=vm
				local result:Bool = Float1 >= Float2
				bco.pos+=1; Local varKind:Int = bco.code[bco.pos]
				Select varKind
					Case expKinds.BC_ARRAYVAR 
						Error("Can't convert from Boolean to array")
				...
				'endtemplate
			Case expKinds.BC_STRINGVAR 
				'loadtemplate ./booleanperformoperation.Monkey, operation=>=, operator1=String1, operator2=String2, bytecodeobj=bco, virtualmachine=vm
				local result:Bool = String1 >= String2
				bco.pos+=1; Local varKind:Int = bco.code[bco.pos]
				Select varKind
					Case expKinds.BC_ARRAYVAR 
						Error("Can't convert from Boolean to array")
	...
	Else
		...
		if opKind1 = expKinds.BC_FLOATVAR 
			...
			ElseIf opKind2 = expKinds.BC_INTVAR
				'loadtemplate ./booleanperformoperation.Monkey, operation=>=, operator1=Float1, operator2=Int2, bytecodeobj=bco, virtualmachine=vm
				local result:Bool = Float1 >= Int2
				bco.pos+=1; Local varKind:Int = bco.code[bco.pos]
				Select varKind
					Case expKinds.BC_ARRAYVAR 
						Error("Can't convert from Boolean to array")
		...
		ElseIf opKind1 = expKinds.BC_INTVAR
			if opKind2 = expKinds.BC_FLOATVAR 
				'loadtemplate ./booleanperformoperation.Monkey, operation=>=, operator1=Int1, operator2=Float2, bytecodeobj=bco, virtualmachine=vm
				local result:Bool = Int1 >= Float2
				bco.pos+=1; Local varKind:Int = bco.code[bco.pos]
				Select varKind
					Case expKinds.BC_ARRAYVAR 
						Error("Can't convert from Boolean to array")
...
Class MAJOR_THAN extends HarplFunction
	'loadtemplate ./Templates/booleanassembleroperation.monkey,operation= >
	'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/booleanassembleroperation.monkey
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
...
Class MINOR_THAN extends HarplFunction
	'loadtemplate ./Templates/booleanassembleroperation.monkey,operation= <
	'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/booleanassembleroperation.monkey
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
...
Class MINOR_EQUAL extends HarplFunction
	'loadtemplate ./Templates/booleanassembleroperation.monkey,operation= <=
	'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/booleanassembleroperation.monkey
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
...
Class NOTEQUALS extends HarplFunction
	'loadtemplate ./Templates/booleanassembleroperation.monkey,operation= <>
	'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/booleanassembleroperation.monkey
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
...
Class EQUALS extends HarplFunction
	'loadtemplate ./Templates/booleanassembleroperation.monkey,operation= =
	'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/booleanassembleroperation.monkey
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
