...
Class Unary_AsString extends HarplFunction 
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
		...
		Select opKind1
			Case expKinds.BC_FLOATVAR 
				'loadtemplate ./Templates/settovar.monkey,bytecode=bco,virtualmachine=vm, datasource=Strings, result=Float1
				'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settovar.monkey
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				bco.pos+=1; Local scopeNum:Int = bco.code[bco.pos]
				Local localScope:DynamicDataScope = vm.dataScope.GetdynamicScope(scopeNum)
				localScope.Strings[varNum] = Float1
				'#End Region
				'endtemplate
		
			Case expKinds.BC_INTVAR
				'loadtemplate ./Templates/settovar.monkey,bytecode=bco,virtualmachine=vm, datasource=Strings, result=Int1
				'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settovar.monkey
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				bco.pos+=1; Local scopeNum:Int = bco.code[bco.pos]
				Local localScope:DynamicDataScope = vm.dataScope.GetdynamicScope(scopeNum)
				localScope.Strings[varNum] = Int1
				'#End Region
				'endtemplate
			Case expKinds.BC_STRINGVAR 
				'loadtemplate ./Templates/settovar.monkey,bytecode=bco,virtualmachine=vm, datasource=Strings, result=String1
				'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settovar.monkey
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				bco.pos+=1; Local scopeNum:Int = bco.code[bco.pos]
				Local localScope:DynamicDataScope = vm.dataScope.GetdynamicScope(scopeNum)
				localScope.Strings[varNum] = String1
				'#End Region
				'endtemplate		
			
			Case expKinds.BC_BOOLVAR
				if Bool1 Then
					'loadtemplate ./Templates/settovar.monkey,bytecode=bco,virtualmachine=vm, datasource=Strings, result="1"
					'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settovar.monkey
					bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
					bco.pos+=1; Local scopeNum:Int = bco.code[bco.pos]
					Local localScope:DynamicDataScope = vm.dataScope.GetdynamicScope(scopeNum)
					localScope.Strings[varNum] = "1"
					'#End Region
					'endtemplate
				Else
					'loadtemplate ./Templates/settovar.monkey,bytecode=bco,virtualmachine=vm, datasource=Strings, result="0"
					'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settovar.monkey
					bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
					bco.pos+=1; Local scopeNum:Int = bco.code[bco.pos]
					Local localScope:DynamicDataScope = vm.dataScope.GetdynamicScope(scopeNum)
					localScope.Strings[varNum] = "0"
					'#End Region
					'endtemplate		
				EndIf
			Default
