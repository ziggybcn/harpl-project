...
Class Unary_AsString extends HarplFunction 
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
		...
		Select opKind1
			Case expKinds.BC_FLOATVAR 
				'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpStrings, result=Float1
				'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				vm.tmpStrings[varNum] = Float1 
				'#End Region
				'endtemplate
		
			Case expKinds.BC_INTVAR
				'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpStrings, result=Int1
				'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				vm.tmpStrings[varNum] = Int1 
				'#End Region
				'endtemplate
			Case expKinds.BC_STRINGVAR 
				'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpStrings, result=String1
				'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				vm.tmpStrings[varNum] = String1 
				'#End Region
				'endtemplate		
			
			Case expKinds.BC_BOOLVAR
				if Bool1 Then
					'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpStrings, result="1"
					'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
					bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
					vm.tmpStrings[varNum] = "1" 
					'#End Region
					'endtemplate
				Else
					'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpStrings, result="0"
					'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
					bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
					vm.tmpStrings[varNum] = "0" 
					'#End Region
					'endtemplate		
				EndIf
...
Class Unary_AsInteger extends HarplFunction 
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
		...
		'PERFORM OPERATION:
		bco.pos+=1 'We consume the TMP marker as it is only for compatibility purposes.
		Select opKind1
			Case expKinds.BC_FLOATVAR 
				'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpInt, result=Float1
				'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				vm.tmpInt[varNum] = Float1 
				'#End Region
				'endtemplate
		
			Case expKinds.BC_INTVAR
				'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpInt, result=Int1
				'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				vm.tmpInt[varNum] = Int1 
				'#End Region
				'endtemplate
			Case expKinds.BC_STRINGVAR 
				'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpInt, result=Int(String1)
				'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				vm.tmpInt[varNum] = Int(String1) 
				'#End Region
				'endtemplate		
			
			Case expKinds.BC_BOOLVAR
				if Bool1 Then
					'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpInt, result=1
					'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
					bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
					vm.tmpInt[varNum] = 1 
					'#End Region
					'endtemplate
				Else
					'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpInt, result=0
					'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
					bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
					vm.tmpInt[varNum] = 0 
					'#End Region
...
Class Unary_AsFloat extends HarplFunction 
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
		...
		Select opKind1
			Case expKinds.BC_FLOATVAR 
				'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpFloat, result=Float1
				'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				vm.tmpFloat[varNum] = Float1 
				'#End Region
				'endtemplate
		
			Case expKinds.BC_INTVAR
				'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpFloat, result=Int1
				'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				vm.tmpFloat[varNum] = Int1 
				'#End Region
				'endtemplate
			Case expKinds.BC_STRINGVAR 
				'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpFloat, result=Float(String1)
				'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				vm.tmpFloat[varNum] = Float(String1) 
				'#End Region
				'endtemplate		
			
			Case expKinds.BC_BOOLVAR
				if Bool1 Then
					'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpFloat, result=1.0
					'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
					bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
					vm.tmpFloat[varNum] = 1.0 
					'#End Region
					'endtemplate
				Else
					'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm, source=tmpFloat, result=0.0
					'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
					bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
					vm.tmpFloat[varNum] = 0.0 
					'#End Region
					'endtemplate		
				EndIf
...
Class Unary_AsBool extends HarplFunction 
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
		...
		'PERFORM OPERATION:
		Local booleanResult:Bool = Bool1
		'loadtemplate ./Templates/ConvertAsBoolean.monkey,opKind=opKind1, BoolVar=booleanResult, FloatVar=Float1, IntVar=Int1, StringVar = String1			
		'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/ConvertAsBoolean.monkey
		Select opKind1
			Case expKinds.BC_ARRAYVAR 
			...
			Case expKinds.BC_BOOLVAR 
				'Nothing to convert
			Case expKinds.BC_FLOATVAR 
				booleanResult = Float1<>0
			Case expKinds.BC_INTVAR 
				booleanResult = Int1<>0
			Case expKinds.BC_STRINGVAR 
				booleanResult = String1<>""
		End Select
		opKind1 = expKinds.BC_BOOLVAR
		'#End Region
		'endtemplate
		bco.pos+=1
		'loadtemplate ./Templates/settotmp.monkey,bytecode=bco,virtualmachine=vm,source=tmpBool, result=booleanResult
		'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settotmp.monkey
		bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
		vm.tmpBool[varNum] = booleanResult 
		'#End Region
		'endtemplate
		bco.pos+=1
	End
...
Class Set_True extends HarplFunction 

	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
		bco.pos+=1 'We know it is a boolean. Only booleans are allowed here.
		'loadtemplate ./Templates/settovar.monkey,bytecode=bco,virtualmachine=vm,datasource=Booleans,result=True
		'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/settovar.monkey
		bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
		bco.pos+=1; Local scopeNum:Int = bco.code[bco.pos]
		Local localScope:DynamicDataScope = vm.dataScope.GetdynamicScope(scopeNum)
		localScope.Booleans[varNum] = True
		'#End Region
		'endtemplate
	End
