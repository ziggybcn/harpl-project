...
Class Sub extends HarplFunction 
	'loadtemplate ./Templates/numericassembleroperation.Monkey,operation=-
	'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/numericassembleroperation.Monkey
...
Class Sum extends HarplFunction 
	'loadtemplate ./Templates/numericassembleroperation.Monkey,operation=+
	'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/numericassembleroperation.Monkey
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
...
Class Mul extends HarplFunction 
	'loadtemplate ./Templates/numericassembleroperation.Monkey,operation=*
	'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/numericassembleroperation.Monkey
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
...
Class Div extends HarplFunction 
	'loadtemplate ./Templates/numericassembleroperation.Monkey,operation=/
	'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/numericassembleroperation.Monkey
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
...
Class Modulus extends HarplFunction 
	'loadtemplate ./Templates/numericassembleroperation.Monkey,operation=Mod
	'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/numericassembleroperation.Monkey
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
...
ElseIf opKind1 = expKinds.BC_INTVAR
	if opKind2 = expKinds.BC_FLOATVAR 
		...
		'endtemplate
	ElseIf opKind2 = expKinds.BC_INTVAR
		'loadtemplate ./Templates/performfunctionoperation.Monkey, function=PowInt, resultkind = Int, operator1=Int1, operator2=Int2, bytecodeobj=bco, virtualmachine=vm
		'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/performfunctionoperation.Monkey
		local result:Int = PowInt ( Int1 , Int2 )
		bco.pos+=1; Local varKind:Int = bco.code[bco.pos]
		Select varKind
			Case expKinds.BC_ARRAYVAR 
