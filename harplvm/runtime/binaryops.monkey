...
Class SUB extends HarplFunction 
	...
	if true
		...
		Select varKind
			...
			Case expKinds.BC_TMPBOOL
				'LoadTemplate ./accestmp.Monkey, bytecode=bco, virtualmachine = vm, result = Bool1, source=tmpBool, opkind = opKind1, opvalue = expKinds.BC_TMPBOOL
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				Bool1 = vm.tmpBool[varNum]
				opKind1 = expKinds.BC_TMPBOOL
				'endtemplate
			Case expKinds.BC_TMPFLOAT 
				'LoadTemplate ./accestmp.Monkey, bytecode=bco, virtualmachine = vm, result = Float1, source=tmpFloat, opkind = opKind1, opvalue = expKinds.BC_TMPFLOAT
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				Float1 = vm.tmpFloat[varNum]
				opKind1 = expKinds.BC_TMPFLOAT
				'endtemplate
			Case expKinds.BC_TMPINTEGER 
				'LoadTemplate ./accestmp.Monkey, bytecode=bco, virtualmachine = vm, result = Int1, source=tmpInt, opkind = opKind1, opvalue = expKinds.BC_TMPINTEGER
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				Int1 = vm.tmpInt[varNum]
				opKind1 = expKinds.BC_TMPINTEGER
				'endtemplate
			Case expKinds.BC_TMPSTRING 
				'LoadTemplate ./accestmp.Monkey, bytecode=bco, virtualmachine = vm, result = String1, source=tmpStrings, opkind = opKind1, opvalue = expKinds.BC_TMPSTRING
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				String1 = vm.tmpStrings[varNum]
				opKind1 = expKinds.BC_TMPSTRING
				'endtemplate
		End
	endif
	'#End Region
	...
	if true
		...
		Select varKind
			...
			Case expKinds.BC_TMPBOOL
				'LoadTemplate ./accestmp.Monkey, bytecode=bco, virtualmachine = vm, result = Bool2, source=tmpBool, opkind = opKind2, opvalue = expKinds.BC_TMPBOOL
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				Bool2 = vm.tmpBool[varNum]
				opKind2 = expKinds.BC_TMPBOOL
				'endtemplate
			Case expKinds.BC_TMPFLOAT 
				'LoadTemplate ./accestmp.Monkey, bytecode=bco, virtualmachine = vm, result = Float2, source=tmpFloat, opkind = opKind2, opvalue = expKinds.BC_TMPFLOAT
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				Float2 = vm.tmpFloat[varNum]
				opKind2 = expKinds.BC_TMPFLOAT
				'endtemplate
			Case expKinds.BC_TMPINTEGER 
				'LoadTemplate ./accestmp.Monkey, bytecode=bco, virtualmachine = vm, result = Int2, source=tmpInt, opkind = opKind2, opvalue = expKinds.BC_TMPINTEGER
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				Int2 = vm.tmpInt[varNum]
				opKind2 = expKinds.BC_TMPINTEGER
				'endtemplate
			Case expKinds.BC_TMPSTRING 
				'LoadTemplate ./accestmp.Monkey, bytecode=bco, virtualmachine = vm, result = String2, source=tmpStrings, opkind = opKind2, opvalue = expKinds.BC_TMPSTRING
				bco.pos+=1; Local varNum:Int = bco.code[bco.pos]
				String2 = vm.tmpStrings[varNum]
				opKind2 = expKinds.BC_TMPSTRING
				'endtemplate
		End
	endif
	'#End Region
