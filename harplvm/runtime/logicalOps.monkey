...
Class Logical_And extends HarplFunction 
	'loadtemplate ./Templates/LogicalAssemblerOperation.Monkey,operation= And 
	'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/LogicalAssemblerOperation.Monkey
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
		...
		'PERFORM OPERATION:
		'loadtemplate ./booleanperformoperation.monkey, operation=And, resultkind = Bool, operator1=Bool1, operator2=Bool2, bytecodeobj=bco, virtualmachine=vm
		local result:Bool = Bool1 And Bool2
...
Class Logical_Or extends HarplFunction 
	'loadtemplate ./Templates/LogicalAssemblerOperation.Monkey,operation= Or 
	'#Region Code generated by the Harpl-Monkey template. Loaded from: ./Templates/LogicalAssemblerOperation.Monkey
	Method Run:Void(vm:Hvm,bco:ByteCodeObj)
		...
		'PERFORM OPERATION:
		'loadtemplate ./booleanperformoperation.monkey, operation=Or, resultkind = Bool, operator1=Bool1, operator2=Bool2, bytecodeobj=bco, virtualmachine=vm
		local result:Bool = Bool1 Or Bool2
		bco.pos+=1; Local varKind:Int = bco.code[bco.pos]
		Select varKind
			Case expKinds.BC_ARRAYVAR 
				Error("Can't convert from Boolean to array")
